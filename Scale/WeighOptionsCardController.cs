	...
	public class WeighOptionsCardController : CardController
	{
		...
		public override IEnumerator Play()
		{
			...
			for (int i = 0; i < 2; i++)
			{
				...
				Function destroy = new Function(DecisionMaker, "Destroy an ongoing or environment card", SelectionType.DestroyCard, () => GameController.SelectAndDestroyCard(base.HeroTurnTakerController, new LinqCardCriteria((Card c) => IsOngoing(c) || c.IsEnvironment, "ongoing or environment"), optional: false, null, null, GetCardSource()));
