...
namespace GuardiansOfTomorrow.Starstone
{
	...
	public class SentryPillarCardController : CardController
	{
		public SentryPillarCardController(Card card, TurnTakerController turnTakerController)
		...
		private IEnumerator FirstDamageDealtResponse(DealDamageAction dd)
		{
			...
			IEnumerator coroutine = DealDamage(base.Card, dd.DamageSource.Card, 2, DamageType.Projectile);
