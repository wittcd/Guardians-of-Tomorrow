...
namespace GuardiansOfTomorrow.Starstone
{
	...
	public class StoneshapeCardController : CardController
	{
		...
		{
			IEnumerator coroutine = base.GameController.SelectAndReturnCards(base.HeroTurnTakerController, 1, new LinqCardCriteria((Card c) => c.DoKeywordsContain("stone", false, false), "stone"), toHand: true, toDeck: false, optional: false, 0, null, null, GetCardSource());
