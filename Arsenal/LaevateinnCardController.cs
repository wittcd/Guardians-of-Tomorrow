...
{
    class LaevateinnCardController : ArsenalRelicCardController
    {
        public LaevateinnCardController(Card card, TurnTakerController turnTakerController)
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger<DealDamageAction>((DealDamageAction dd) => dd.DamageSource.Card == CharacterCard && dd.DamageType == DamageType.Projectile && GetNumberOfProjectileDealtThisTurn() <= 1 && dd.TargetHitPointsAfterBeingDealtDamage <= 2, (DealDamageAction dd) => GameController.DestroyCard(DecisionMaker, dd.Target, cardSource: GetCardSource()), TriggerType.DestroyCard, TriggerTiming.After);
        }
    }
}
